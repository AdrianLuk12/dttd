...
print(f"Hour with highest skip rate: {hourly_skip_rate.loc[hourly_skip_rate['skip_rate'].idxmax(), 'category']} ({hourly_skip_rate['skip_rate'].max() / 100:.2%})")
print(f"Hour with lowest skip rate: {hourly_skip_rate.loc[hourly_skip_rate['skip_rate'].idxmin(), 'category']} ({hourly_skip_rate['skip_rate'].min() / 100:.2%})")
